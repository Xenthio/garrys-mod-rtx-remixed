...
RemixCategoryManager.CATEGORY = {
    ...
    RASTER_OVERLAY            = bit.lshift(1, 26), -- 0x4000000
}
...
RemixCategoryManager.PRESET = {
    ...
    -- For raster-only overlays that should draw after RTX compositing
    RASTER_OVERLAY = RemixCategoryManager.CATEGORY.RASTER_OVERLAY, -- 0x4000000
...
--[[
    ...
    Category flags: DECAL_STATIC=0x1000  PARTICLE=0x400  LEGACY_EMISSIVE=0x1000000
                    ...
                    VIEW_SURFACE=0x2000000  RASTER_OVERLAY=0x4000000
...
concommand.Add("rtx_set_hash_category", function(ply, cmd, args)
    if not args[1] or not args[2] then
        ...
        MsgC(Color(255, 200, 100), "         0x4=SKY  0x8=IGNORE  0x40000=ANIMATED_WATER  0x2000000=VIEW_SURFACE  0x4000000=RASTER_OVERLAY\n")
        return
    end
