...
hook.Add("PopulateToolMenu", "RemixAPILights", function()
    spawnmenu.AddToolMenuOption("Utilities", "RTX Remix - API Lights", "RTX_Remix_API_Lights", "Map", "", "", function(panel)
        ...
        panel:NumSlider("VRAD Scale", "rtx_api_map_lights_env_vrad_scale", 0.0001, 0.01, 4)
        ...
        panel:Help("")
        panel:Help("Ambient Sky (from light_environment)")
        panel:CheckBox("Apply Ambient to Sky", "rtx_api_map_lights_env_ambient_to_sky")
        panel:NumSlider("Ambient Scale", "rtx_api_map_lights_env_ambient_scale", 0, 0.05, 4)
        ...
        btnEnvReset.DoClick = function()
            ...
            RunConsoleCommand("rtx_api_map_lights_env_vrad_scale", "0.001")
            ...
            RunConsoleCommand("rtx_api_map_lights_env_ambient_to_sky", "1")
            RunConsoleCommand("rtx_api_map_lights_env_ambient_scale", "0.005")
        end

        -- Section: Debug
        panel:Help("Debug")
        panel:Button("Env Light Diagnostics", "rtx_api_map_lights_debug_env")
